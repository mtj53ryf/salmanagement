...
class Ui_Dialog(object):
    ...
    #定义一个添加员工信息的函数
        try:
            ...
            if "'" in var_empno or "'" in var_sal or "'" in var_deptno:
                self.messagelabel.setText("输入有误，请重新输入！")
            else:
                conn = cx_Oracle.connect('system/bc1234567897@localhost:1521/orcl')  # 连接数据库
                c = conn.cursor()  # 获取cursor
                c.execute('insert into emp values({},{},{},{},{},{},{},{})'.format(var_empno, var_ename, var_sex,var_birthdate, var_job, var_sal,var_hiredate,var_deptno))  # 使用cursor进行各种操作
    ...
    def setupUi(self, Dialog):
        ...
        self.b_ok.clicked.connect(self.insert_emp)
