...
class Ui_MainWindow(object):
    ...
    #添加工资信息
    def insert_sal(self):
        os.system('python insert_sal.py')
    #删除工资信息
    def delete_sal(self):
        os.system('python delete_sal.py')
    #修改工资信息
    def update_sal(self):
        os.system('python update_sal.py')
    #定义工资管理系统界面
    def setupUi(self, MainWindow):
        ...
        self.b_view_sal.setGeometry(QtCore.QRect(0, 20, 93, 28))
        ...
        self.b_select_sal.setGeometry(QtCore.QRect(170, 20, 93, 28))
        self.b_select_sal.setObjectName("b_select_sal")
        self.b_select_sal.clicked.connect(self.select_sal)
        self.b_insert_sal = QtWidgets.QPushButton(self.groupBox) #添加数据按钮
        self.b_insert_sal.setGeometry(QtCore.QRect(350, 20, 93, 28))
        self.b_insert_sal.setObjectName("b_insert_sal")
        self.b_insert_sal.clicked.connect(self.insert_sal)
        self.b_delete_sal = QtWidgets.QPushButton(self.groupBox) #删除数据按钮
        self.b_delete_sal.setGeometry(QtCore.QRect(520, 20, 93, 28))
        self.b_delete_sal.setObjectName("b_delete_sal")
        self.b_delete_sal.clicked.connect(self.delete_sal)
        self.b_update_sal = QtWidgets.QPushButton(self.groupBox) #修改数据按钮
        self.b_update_sal.setGeometry(QtCore.QRect(700, 20, 93, 28))
        self.b_update_sal.setObjectName("b_update_sal")
        self.b_update_sal.clicked.connect(self.update_sal)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b_insert_sal.setText(_translate("MainWindow", "添加数据"))
        self.b_delete_sal.setText(_translate("MainWindow", "删除数据"))
        self.b_update_sal.setText(_translate("MainWindow", "修改数据"))
