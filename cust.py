...
class Ui_MainWindow(object):
    ...
    def insert_cust(self):
        os.system('python insert_cust.py')
    #删除客户信息
    def delete_cust(self):
        os.system('python delete_cust.py')
    #修改客户信息
    def update_cust(self):
        os.system('python update_cust.py')
    #定义客户管理系统界面
    def setupUi(self, MainWindow):
        ...
        self.b_view_cust.setGeometry(QtCore.QRect(0, 20, 93, 28))
        ...
        self.b_select_cust.setGeometry(QtCore.QRect(170, 20, 93, 28))
        self.b_select_cust.setObjectName("b_select_cust")
        self.b_select_cust.clicked.connect(self.select_cust)
        self.b_insert_cust = QtWidgets.QPushButton(self.groupBox) #添加数据按钮
        self.b_insert_cust.setGeometry(QtCore.QRect(350, 20, 93, 28))
        self.b_insert_cust.setObjectName("b_insert_cust")
        self.b_insert_cust.clicked.connect(self.insert_cust)
        self.b_delete_cust = QtWidgets.QPushButton(self.groupBox) #删除数据按钮
        self.b_delete_cust.setGeometry(QtCore.QRect(520, 20, 93, 28))
        self.b_delete_cust.setObjectName("b_delete_cust")
        self.b_delete_cust.clicked.connect(self.delete_cust)
        self.b_update_cust = QtWidgets.QPushButton(self.groupBox) #修改数据按钮
        self.b_update_cust.setGeometry(QtCore.QRect(700, 20, 93, 28))
        self.b_update_cust.setObjectName("b_update_cust")
        self.b_update_cust.clicked.connect(self.update_cust)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b_insert_cust.setText(_translate("MainWindow", "添加数据"))
        self.b_delete_cust.setText(_translate("MainWindow", "删除数据"))
        self.b_update_cust.setText(_translate("MainWindow", "修改数据"))
