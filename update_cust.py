...
class Ui_Dialog(object):
    ...
    def update_cust(self):
        try:
            ...
            if "'" in var_custno or "'" in var_phone or var_custname=='' or var_sex=='' or var_birthdate=='' or var_phone=='':
                ...
                if (rs == []):
                    ...
                    c.execute('update cust set custname={},sex={},birthdate={},phone={} where custno={}'.format(var_custname,var_sex,var_birthdate,var_phone,var_custno))  # 使用cursor进行各种操作
    ...
    def setupUi(self, Dialog):
        ...
        self.b_ok.clicked.connect(self.update_cust)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "根据客户号修改对应客户信息"))
