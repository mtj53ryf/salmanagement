...
class Ui_Dialog(object):
        ...
        try:
            ...
            if "'" in var_deptno or var_dname =='' or var_mgrname=='':
                ...
                if (rs == []):
                    ...
                    c.execute('update dept set dname={},mgrname={} where deptno={}'.format(var_dname,var_mgrname,var_deptno))  # 使用cursor进行各种操作
    ...
    def setupUi(self, Dialog):
        ...
        self.b_ok.clicked.connect(self.update_dept)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "根据部门号修改对应部门信息"))
