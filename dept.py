...
class Ui_MainWindow(object):
    ...
    def insert_dept(self):
        os.system('python insert_dept.py')
    #删除部门信息
    def delete_dept(self):
        os.system('python delete_dept.py')
    #修改部门信息
    def update_dept(self):
        os.system('python update_dept.py')
    #定义部门管理系统界面
    def setupUi(self, MainWindow):
        ...
        self.b_view_dept.setGeometry(QtCore.QRect(0, 20, 93, 28))
        ...
        self.b_select_dept.setGeometry(QtCore.QRect(170, 20, 93, 28))
        self.b_select_dept.setObjectName("b_select_dept")
        self.b_select_dept.clicked.connect(self.select_dept)
        self.b_insert_dept = QtWidgets.QPushButton(self.groupBox) #添加数据按钮
        self.b_insert_dept.setGeometry(QtCore.QRect(350, 20, 93, 28))
        self.b_insert_dept.setObjectName("b_insert_dept")
        self.b_insert_dept.clicked.connect(self.insert_dept)
        self.b_delete_dept = QtWidgets.QPushButton(self.groupBox) #删除数据按钮
        self.b_delete_dept.setGeometry(QtCore.QRect(520, 20, 93, 28))
        self.b_delete_dept.setObjectName("b_delete_dept")
        self.b_delete_dept.clicked.connect(self.delete_dept)
        self.b_update_dept = QtWidgets.QPushButton(self.groupBox) #修改数据按钮
        self.b_update_dept.setGeometry(QtCore.QRect(700, 20, 93, 28))
        self.b_update_dept.setObjectName("b_update_dept")
        self.b_update_dept.clicked.connect(self.update_dept)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b_insert_dept.setText(_translate("MainWindow", "添加数据"))
        self.b_delete_dept.setText(_translate("MainWindow", "删除数据"))
        self.b_update_dept.setText(_translate("MainWindow", "修改数据"))
